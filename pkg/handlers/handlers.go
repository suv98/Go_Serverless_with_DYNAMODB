...
import (
	...
	"github.com/subratkumarsahu/go-serverless/pkg/user"
)
...
func DeleteUser(req events.APIGatewayProxyRequest, tableNmae string, dynaClient dynamodbiface.DynamoDBAPI) (
	*events.APIGatewayProxyResponse, error,
) {

	err := user.DeleteUser(req, tableNmae, dynaClient)
